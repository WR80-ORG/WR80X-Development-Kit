...
The **WR80DBG** is the official debugger for the **WR80 architecture**, designed to interact with the WR80EMU emulator.
...
| Command | Description |
|----------|-------------|
| `make` | Builds the debugger in the `/build` directory. |
